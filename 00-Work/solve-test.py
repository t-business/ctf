...
def get_possible_flags():
    ...
    p.hook(0x08048657, angr.SIM_PROCEDURES['libc']['strcmp']())
    p.hook(0x080485F5, angr.SIM_PROCEDURES['libc']['printf']())
    p.hook(0x08048657, angr.SIM_PROCEDURES['libc']['scanf']())

    # let's grab the password to compare
    p.hook(0x08048757, length=9)
